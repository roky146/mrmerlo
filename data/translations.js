export const translations = {
  es: {
    ...
    currently_working:'Trabajando en',
    currently_studying:'Estudiando',
    currently_building:'Construyendo',
    ...
    proj_year:       'Año',
    proj_tags:       'Tags',
    proj_overview:   'Resumen',
    proj_features:   'Funcionalidades',
    proj_tech:       'Tecnologías',
    proj_palette:    'Paleta de colores',
    proj_typography: 'Tipografía',
    proj_more:       'Más proyectos',
    proj_view_repo:  'Ver repositorio →',
    proj_private:    'Repositorio privado',
    proj_main_view:  'vista principal',
    proj_view:       'Vista',
    not_found_msg:   'Esta URL no existe o fue movida. Vuelve al inicio y desde ahí llegamos a donde sea.',
  ...
  en: {
    ...
    proj_typography: 'Typography',
    proj_more:       'More projects',
    proj_view_repo:  'View repository →',
    proj_private:    'Private repository',
    proj_main_view:  'main view',
    proj_view:       'View',
    not_found_msg:   'This URL does not exist or was moved. Head back home and we will get you anywhere from there.',
    back_home:       '← Back home',
  },
  ...
  it: {
    ...
    skill_platforms:  'Piattaforme',
    skill_security:   'Cybersecurity',
    skill_tools:      'Strumenti',
    ...
    currently_working:'Lavorando a',
    currently_studying:'Studiando',
    currently_building:'Sviluppando',
    ...
    proj_year:       'Anno',
    proj_tags:       'Tag',
    proj_overview:   'Panoramica',
    proj_features:   'Funzionalità',
    proj_tech:       'Tecnologie',
    proj_palette:    'Palette di colori',
    proj_typography: 'Tipografia',
    proj_more:       'Altri progetti',
    proj_view_repo:  'Vedi repository →',
    proj_private:    'Repository privato',
    proj_main_view:  'vista principale',
    proj_view:       'Vista',
    not_found_msg:   'Questo URL non esiste o è stato spostato. Torna alla home e da lì arriviamo ovunque.',
  ...
  fr: {
    ...
    skill_platforms:  'Plateformes',
    skill_security:   'Cybersécurité',
    skill_tools:      'Outils',
    ...
    currently_working:'Travaillant à',
    currently_studying:'Étudiant',
    currently_building:'Développant',
    ...
    proj_year:       'Année',
    proj_tags:       'Tags',
    proj_overview:   'Aperçu',
    proj_features:   'Fonctionnalités',
    proj_tech:       'Technologies',
    proj_palette:    'Palette de couleurs',
    proj_typography: 'Typographie',
    proj_more:       'Plus de projets',
    proj_view_repo:  'Voir le dépôt →',
    proj_private:    'Dépôt privé',
    proj_main_view:  'vue principale',
    proj_view:       'Vue',
    not_found_msg:   "Cette URL n'existe pas ou a été déplacée. Reviens à l'accueil et de là on va partout.",
  ...
  pt: {
    ...
    currently_working:'Trabalhando em',
    currently_studying:'Estudando',
    currently_building:'Construindo',
    ...
    proj_year:       'Ano',
    proj_tags:       'Tags',
    proj_overview:   'Visão geral',
    proj_features:   'Funcionalidades',
    proj_tech:       'Tecnologias',
    proj_palette:    'Paleta de cores',
    proj_typography: 'Tipografia',
    proj_more:       'Mais projetos',
    proj_view_repo:  'Ver repositório →',
    proj_private:    'Repositório privado',
    proj_main_view:  'vista principal',
    proj_view:       'Vista',
    not_found_msg:   'Este URL não existe ou foi movido. Volta ao início e a partir daí chegamos a qualquer lado.',
