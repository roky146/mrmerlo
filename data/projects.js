...
export const featuredProjects = [
  {
    ...
    kind: { es: 'App de escritorio', en: 'Desktop app', it: 'App desktop', fr: 'App de bureau', pt: 'App de desktop' },
    year: '2026',
    color: '#35D69A',
    colorDark: '#23A97A',
...

  {
    ...
    kind: { es: 'Cloud-native', en: 'Cloud-native', it: 'Cloud-native', fr: 'Cloud-native', pt: 'Cloud-native' },
    year: '2026',
    color: '#3E9AC4',
    colorDark: '#2C7B9E',
    ...
    palette: ['#0B0F13', '#3E9AC4', '#2C7B9E', '#E9EEF3'],
